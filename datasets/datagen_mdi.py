...
from datasets.transforms.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from datasets.transforms.downsampling import DownsampleSegForDSTransform3, DownsampleSegForDSTransform2
from datasets.transforms.pyramid_augmentations import MoveSegAsOneHotToData, \
